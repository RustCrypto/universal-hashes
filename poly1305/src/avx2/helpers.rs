    ...
    pub(super) fn reduce(self) -> Aligned130 {
        unsafe {
            ...
            x.v0 = _mm256_add_epi64(
                _mm256_and_si256(x.v0, _mm256_set_epi64x(-1, 0x3ffffff, 0x3ffffff, 0x3ffffff)),
            ...
            x.v1 = _mm256_add_epi64(
                x.v1,
                _mm256_permute4x64_epi64(_mm256_srli_epi64(x.v0, 26), set02(2, 1, 0, 3)),
            );
            // [
            //     (t_3 + t_2 >> 26) % 2^26,
            //     t_2 % 2^26 + t_1 >> 26,
            ...
            //     t_0 % 2^26,
            // ]
            let chain = _mm256_and_si256(x.v0, _mm256_set_epi64x(0x3ffffff, -1, -1, -1));

            // - Reduction modulus 2^130-5
            // t = [0, 0, 0, (t_4 + (t_3 + t_2 >> 26) >> 26) >> 26]
            let t = _mm256_srlv_epi64(x.v1, _mm256_set_epi64x(64, 64, 64, 26));
            // chain + 5·t = [
            //     (t_3 + t_2 >> 26) % 2^26,
            //     t_2 % 2^26 + t_1 >> 26,
            //     t_1 % 2^26 + t_0 >> 26,
            //     t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26),
            // ]
            let red_0 = _mm256_add_epi64(_mm256_add_epi64(chain, t), _mm256_slli_epi32(t, 2));
            // [0, 0, 0, (t_4 + (t_3 + t_2 >> 26) >> 26) % 2^26]
            let red_1 = _mm256_and_si256(x.v1, _mm256_set_epi64x(0, 0, 0, 0x3ffffff));

            // - Second carry chain:
            // [
            //     (t_3 + t_2 >> 26) % 2^26,
            //     (t_2 % 2^26 + t_1 >> 26) % 2^26,
            //     (t_1 % 2^26 + t_0 >> 26) % 2^26,
            //     (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) % 2^26,
            // ] + [
            //     (t_2 % 2^26 + t_1 >> 26) >> 26,
            //     (t_1 % 2^26 + t_0 >> 26) >> 26,
            //     (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) >> 26,
            //     0,
            // ] = [
            //     (t_3 + t_2 >> 26) % 2^26 + (t_2 % 2^26 + t_1 >> 26) >> 26,
            //     (t_2 % 2^26 + t_1 >> 26) % 2^26 + (t_1 % 2^26 + t_0 >> 26) >> 26,
            //     (t_1 % 2^26 + t_0 >> 26) % 2^26 + (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) >> 26,
            //     (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) % 2^26,
            // ]
            let chain = _mm256_add_epi64(
                _mm256_and_si256(
                    red_0,
                    _mm256_set_epi64x(-1, 0x3ffffff, 0x3ffffff, 0x3ffffff),
                ),
                _mm256_permute4x64_epi64(
                    _mm256_srlv_epi64(red_0, _mm256_set_epi64x(64, 26, 26, 26)),
                    set02(2, 1, 0, 3),
                ),
            );
            //   [0, 0, 0, (t_4 + (t_3 + t_2 >> 26) >> 26) % 2^26]
            // + [
            //     ((t_2 % 2^26 + t_1 >> 26) % 2^26 + (t_1 % 2^26 + t_0 >> 26) >> 26) >> 26,
            //     ((t_1 % 2^26 + t_0 >> 26) % 2^26 + (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) >> 26) >> 26,
            //     ((t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) % 2^26) >> 26,
            //     ((t_3 + t_2 >> 26) % 2^26 + (t_2 % 2^26 + t_1 >> 26) >> 26) >> 26,
            // ] = [
            //     ((t_2 % 2^26 + t_1 >> 26) % 2^26 + (t_1 % 2^26 + t_0 >> 26) >> 26) >> 26,
            //     ((t_1 % 2^26 + t_0 >> 26) % 2^26 + (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) >> 26) >> 26,
            //     ((t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) % 2^26) >> 26,
            //     (t_4 + (t_3 + t_2 >> 26) >> 26) % 2^26 + ((t_3 + t_2 >> 26) % 2^26 + (t_2 % 2^26 + t_1 >> 26) >> 26) >> 26,
            // ]
            let red_1 = _mm256_add_epi64(
                red_1,
                _mm256_permute4x64_epi64(_mm256_srli_epi64(chain, 26), set02(2, 1, 0, 3)),
            );
            // [
            //     ((t_3 + t_2 >> 26) % 2^26 + (t_2 % 2^26 + t_1 >> 26) >> 26) % 2^26,
            //     (t_2 % 2^26 + t_1 >> 26) % 2^26 + (t_1 % 2^26 + t_0 >> 26) >> 26,
            //     (t_1 % 2^26 + t_0 >> 26) % 2^26 + (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) >> 26,
            //     (t_0 % 2^26 + 5·((t_4 + (t_3 + t_2 >> 26) >> 26) >> 26)) % 2^26,
            // ]
            let red_0 = _mm256_and_si256(chain, _mm256_set_epi64x(0x3ffffff, -1, -1, -1));
